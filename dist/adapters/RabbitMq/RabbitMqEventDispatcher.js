...
exports.RabbitMqEventDispatcher = void 0;
const inversify_1 = require("inversify");
const amqp = __importStar(require("amqplib"));
const uuid_1 = require("uuid");
let RabbitMqEventDispatcher = class RabbitMqEventDispatcher {
    connection;
    ...
    async dispatch(domainEvent) {
        ...
        const partitionKeyId = (0, uuid_1.v4)();
...
RabbitMqEventDispatcher = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [Object])
], RabbitMqEventDispatcher);
exports.RabbitMqEventDispatcher = RabbitMqEventDispatcher;
